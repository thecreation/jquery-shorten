    ...
    var shorten = function() {
      ...
      _createClass(shorten, [{
        ...
        value: function _prepare() {
          ...
          this.$element.html(this.summaryText + this._ellipsesHtml() + '<span class="' + this.namespace + '-detail">' + this.detailText + '</span>' + this._toggleHtml());
        }
      }, {
        key: '_ellipsesHtml',
        ...
        value: function _bindEvents() {
          ...
          var that = this;
          this.$element.on('click.shorten', '.' + this.namespace + '-toggle',
